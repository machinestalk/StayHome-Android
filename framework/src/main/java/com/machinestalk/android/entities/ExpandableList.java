...
public class ExpandableList {
	...
	/**
	 * @param group the index of the {@link ExpandableGroup} in the full
	 *            collection {@link #groups}
	 * @return the number of visible row items for the particular group. If the
	 *         group is collapsed, return 1 for the group header. If the group
	 *         is expanded return total number of children in the group + 1 for
	 *         the group header
	 */
	...
	/**
	 * Translates a flat list position (the raw position of an item (child or
	 * group) in the list) to either a) group pos if the specified flat list
	 * position corresponds to a group, or b) child pos if it corresponds to a
	 * child. Performs a binary search on the expanded groups list to find the
	 * flat list pos if it is an exp group, otherwise finds where the flat list
	 * pos fits in between the exp groups.
	 *
	...
	/**
	 * @param groupIndex representing the index of a group within
	 *            {@link #groups}
	 * @return the index of a group within the {@link #getVisibleItemCount()}
	 */
	 ...
	 * @return the index of a group within the {@link #getVisibleItemCount()} or
	 *         0 if the groups.indexOf cannot find the group
	 */
	 ...
	 *
	 * @param packedPosition The child positions to be converted in it's packed
	 ...
	 * @param childIndex the index of a child within it's
	...
	/**
	 * @param listPosition An {@link ExpandableListPosition} representing either
	 *            a child or group
	 * @return the total number of children within the group associated with
	 *         the @param listPosition
	 */
	 ...
	 * {@link ExpandableGroup}. If the {@link ExpandableListPosition} is a child
	 * position, it returns the {@link ExpandableGroup} it belongs to
	 *
	 * @param listPosition a {@link ExpandableListPosition} representing either
	 *            a group position or child position
