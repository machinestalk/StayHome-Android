...
public class ExpandableListPosition {
	...
	/**
	 * The position of either the group being referred to, or the parent group
	 * of the child being referred to
	 */
	public int										 groupPos;
	...
	/**
	 * Do not call this unless you obtained this via
	 * ExpandableListPosition.obtain(). PositionMetadata will handle recycling
	 * its own children.
	 */
	public void recycle () {
	...
	public String toString () {
		...
		return "ExpandableListPosition{" + "groupPos=" + groupPos + ", childPos=" + childPos + ", flatListPos=" + flatListPos + ", type=" + type + '}';
	}
}